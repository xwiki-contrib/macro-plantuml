...
public class TemporaryImageWriter implements ImageWriter
{
     ...
     */
    private static final String MODULE_NAME = "plantuml";

    /**
     * Space part of the temporary location where generated image are stored.
     */
    private static final String SPACE = "space";

    /**
     * Page part of the temporary location where generated image are stored.
     */
    ...
    public OutputStream getOutputStream(ImageId imageId) throws MacroExecutionException
    {
        ...
        try {
            ...
            throw new MacroExecutionException("Failed to create the PlantUML image file", e);
        }
        return result;
    }
